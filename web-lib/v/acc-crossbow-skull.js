app.directive('viewAccCrossbowSkull',[
  function(){
    return {
      replace:true,
      restrict:'A',
      template: `
      <div id="viewAccCrossbowSkull" class="view">
        <style>
          #viewAccCrossbowSkull .wrapper {
        ...
        <div class="wrapper center-top center-left">
          <img
            ...
            src="assets/Bloodshine/Skippy Gobblegegoo/Standing Idle3.gif"
